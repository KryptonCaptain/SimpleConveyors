...
public class BlockMetalDevices extends BlockIEBase 
{
	...
	public void registerBlockIcons(IIconRegister iconRegister)
	{
		...
		//11 conveyorBelt
		icons[0][0] = iconRegister.registerIcon("immersiveengineering:metal_conveyor_top");
		icons[0][1] = iconRegister.registerIcon("immersiveengineering:metal_conveyor_top");
		icons[0][2] = iconRegister.registerIcon("immersiveengineering:metal_dynamo_bottom");
		icons[0][3] = iconRegister.registerIcon("immersiveengineering:metal_dynamo_bottom");
