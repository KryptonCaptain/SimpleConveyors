package blusunrize.conveyors.client.gui;
...
import blusunrize.conveyors.client.ClientUtils;
import blusunrize.conveyors.common.blocks.metal.TileEntityConveyorSorter;
import blusunrize.conveyors.common.gui.ContainerSorter;
import blusunrize.conveyors.common.util.Lib;
import blusunrize.conveyors.common.util.network.MessageTileSync;
...
public class GuiSorter extends GuiContainer
{
	...
	protected void drawGuiContainerBackgroundLayer(float f, int mx, int my)
	{
		...
		ClientUtils.bindTexture("conveyors:textures/gui/sorter.png");
