package blusunrize.conveyors.common.blocks;
...
import blusunrize.conveyors.common.blocks.IEBlockInterfaces.IColouredTile;
import blusunrize.conveyors.common.blocks.IEBlockInterfaces.ICustomBoundingboxes;
...
public abstract class BlockIEBase extends BlockContainer
{
	...
	public static class BlockIESimple extends BlockIEBase
	{
		...
		{
			for(int i=0;i<subNames.length;i++)
				icons[i][0] = iconRegister.registerIcon("conveyors:"+name+"_"+subNames[i]);
		}
